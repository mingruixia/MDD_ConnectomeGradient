...
missingdata_regions = union(union(temp1,temp2),1:180);
...
csvwrite([data_dir,'GeneAssociation_lefthemi\PLS_stats.csv'],myStats);
...
save([data_dir,'GeneAssociation_lefthemi\PLS1_ROIscore.mat'],'PLS1_ROIscores_280');
csvwrite([data_dir,'GeneAssociation_lefthemi\PLS1_ROIscores.csv'],XS(:,1));
PLS1_score=XS(:,1);
...
fid1 = fopen([data_dir,'GeneAssociation_lefthemi\PLS1_geneWeights.csv'],'w');
