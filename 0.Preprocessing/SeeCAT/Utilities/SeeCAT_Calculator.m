function varargout = SeeCAT_Calculator(varargin)
% SeeCAT_Calculator MATLAB code for SeeCAT_Calculator.fig
%      SeeCAT_Calculator, by itself, creates a new SeeCAT_Calculator or raises the existing
%      singleton*.
%
%      H = SeeCAT_Calculator returns the handle to a new SeeCAT_Calculator or the handle to
%      the existing singleton*.
%
%      SeeCAT_Calculator('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SeeCAT_Calculator.M with the given input arguments.
%
%      SeeCAT_Calculator('Property','Value',...) creates a new SeeCAT_Calculator or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SeeCAT_Calculator_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SeeCAT_Calculator_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SeeCAT_Calculator

% Last Modified by GUIDE v2.5 01-Jul-2016 10:21:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SeeCAT_Calculator_OpeningFcn, ...
                   'gui_OutputFcn',  @SeeCAT_Calculator_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SeeCAT_Calculator is made visible.
function SeeCAT_Calculator_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SeeCAT_Calculator (see VARARGIN)

% Choose default command line output for SeeCAT_Calculator
...
% UIWAIT makes SeeCAT_Calculator wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SeeCAT_Calculator_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[Names, Path]=uigetfile({'*.hdr;*.nii;*.nii.gz','NIfTI File (*.hdr;*.nii;*.nii.gz)';'*.*', 'All Files (*.*)';},...
